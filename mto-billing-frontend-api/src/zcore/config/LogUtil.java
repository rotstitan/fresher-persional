...
public class LogUtil {
    ...
    public static void init(String prefix) {
        ...
        String file = new StringBuilder().append(apppath).append(File.separator).append(prefix).append("conf").append(File.separator).append(APP_ENV).append("log4j.ini").toString();
